      ...
      <div className=" form-area2">
        ...
        <div className="mb-6">
          ...
          <div className="overflow-y-auto max-h-24 border border-gray-200 p-1">
            ...
            <p>이 약관은 DoRun-DoRun (이하 "회사"라 함)이 제공하는 서비스 "DoRun-DoRun" (이하 "서비스"라 함)의 이용조건 및 절차에 관한 사항을 규정함을 목적으로 합니다.</p>
            <p className="mb-2">제2조 (약관의 효력과 변경)</p>
            <p>본 약관은 서비스를 이용하고자 하는 모든 회원에 대하여 효력이 있습니다.</p>
            <p>회사는 필요 시 본 약관을 변경할 수 있으며, 변경된 약관은 회사가 정한 방법으로 공지함으로써 효력을 발생합니다.</p>
          </div>
        </div>
        <div className="mb-6">
          <h2 className="text-lg font-semibold mb-2 flex items-center">
          ...
          <div className="overflow-y-auto max-h-24 border border-gray-200 p-1">
            ...
            <p>서비스를 이용하기 위해서는 회원 가입이 필요합니다.</p>
            <p>회원은 회사가 요구하는 정보를 정확히 제공하여 가입 절차를 완료하여야 합니다.</p>
            <p className="mb-2">제4조 (개인정보 보호)</p>
            <p>회사는 회원의 개인정보 보호를 위해 최선의 노력을 다하며, 관련 법령에 따라 개인정보 처리 방침을 운영합니다.</p>
            <p>회원은 개인정보의 보호 및 관리에 대한 책임이 있으며, 회사의 안내에 따라 정확한 정보를 제공하여야 합니다.</p>
          </div>
        </div>
        <div className="mb-6">
          <h2 className="text-lg font-semibold mb-2 flex items-center">
          ...
          <div className="overflow-y-auto max-h-24 border border-gray-200 p-1">
            ...
            <p>회원은 본 약관에서 정한 바에 따라 서비스를 이용할 권한을 가집니다.</p>
            <p>회사는 회원에 대한 서비스 제공을 거부할 수 있으며, 이 경우 그 사유를 회원에게 통지합니다.</p>
            <p className="mb-2">제6조 (회원의 의무)</p>
            <p>회원은 본 약관 및 관련 법령을 준수하여 서비스를 이용하여야 합니다.</p>
            <p>회원은 타인의 정보를 도용하거나 부정한 목적으로 서비스를 이용해서는 안됩니다.</p>
          </div>
        </div>
        <div className="mb-6">
          <h2 className="text-lg font-semibold mb-2 flex items-center">
          ...
          <div className="overflow-y-auto max-h-24 border border-gray-200 p-1">
            ...
            <p>회사는 천재지변 또는 기타 불가항력적인 사유로 인하여 서비스 제공에 장애가 발생한 경우에는 책임을 면할 수 있습니다.</p>
            <p>회사는 회원이 서비스를 이용함으로써 발생한 손해에 대하여 일체의 책임을 지지 않습니다.</p>
            <p className="mb-2">제8조 (준거법 및 재판관할)</p>
            <p>본 약관에 명시되지 않은 사항 및 회원과 회사간에 발생한 분쟁에 대하여는 대한민국 법률을 준거법으로 하며, 관할 법원은 서울중앙지방법원으로 합니다.</p>
          </div>
        </div>
        <div className="mb-6">
          <h2 className="text-lg font-semibold mb-2 flex items-center">
          ...
          <p className="text-gray-600">실명 인증된 아이디로 가입, 위치기반서비스 이용약관(선택), 이벤트・혜택 정보 수신(선택) 동의를 포함합니다.</p>
        </div>
